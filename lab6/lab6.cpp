...
int main() {
    ...
    std::vector<std::vector<int>> adjacencyMatrix = {
        {0, INF, INF, INF, INF, 13, INF, INF},
        {INF, 0, INF, INF, INF, INF, 14, INF},
        {INF, INF, 0, INF, INF, INF, 13, 10},
        {INF, INF, 17, 0, INF, 19, INF, 16},
        {18, INF, INF, INF, 0, INF, INF, 14},
        {11, 15, INF, INF, INF, 0, 16, 12},
        {16, INF, INF, INF, INF, INF, 0, 11},
        {10, INF, INF, INF, INF, 19, INF, 0}
    };
